...
export default function Privacidade() {
  return (
    <SafeContainer>
      <ScrollView>
        <Text style={estilos.titulo}>Política de Privacidade do FILMEX</Text>
        ...
        <Text style={estilos.texto}>
          <Text style={estilos.destaque}>A -</Text> Não se envolver em
          atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;
        </Text>

        <Text style={estilos.texto}>
          <Text style={estilos.destaque}>B -</Text> Não difundir propaganda ou
          conteúdo de natureza racista, xenofóbica, ou casas de apostas online,
          jogos de sorte e azar, qualquer tipo de pornografia ilegal, de
          apologia ao terrorismo ou contra os direitos humanos;
        </Text>

        <Text style={estilos.texto}>
          <Text style={estilos.destaque}>C -</Text> Não causar danos aos
          sistemas físicos (hardwares) e lógicos (softwares) do Dá Hora Filmes,
          de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
